...
group array IJ
	...
	trigger                 gg_trg_Nickname4        = null
	trigger                 gg_trg_Nickname5        = null
	trigger                 gg_trg_Decoration        = null
	trigger                 gg_trg_ZamenaHydra        = null
	trigger                 gg_trg_OtmenaChampa        = null
	trigger                 gg_trg_TriggerAtakovan        = null
	trigger                 gg_trg_SpawnImage        = null
...
code ref_function_TUD=null
code ref_function_TYE=null
code ref_function_TYD=null
...
function CreateGrid takes player pl  returns nothing   
    ...
    loop
        ...
        loop
            exitwhen sosy > 16      
            set whichImage = CreateImage("grid.blp",128,128,0, GRID_X, GRID_Y , 0,128/2,128/2,0,3) 
...
function D4E takes nothing returns nothing
    ...
    call CreateMultiboardBJ(5,CountPlayersInForceBJ(YI)+5,IR+"|cffFF0000 (Selecting Modes)|r")
    ...
    set bj_forLoopAIndex=bj_forLoopAIndex+1
    endloop  
    call MultiboardSetItemValueBJ(JR,1,CountPlayersInForceBJ(YI)+4,"|cffA0A0A0West " + I2S(R2I(GetUnitStateSwap(UNIT_STATE_LIFE,H6)))+"|r")
    call MultiboardSetItemValueBJ(JR,1,CountPlayersInForceBJ(YI)+5,"|cFF7EBFF1East "+  I2S(R2I(GetUnitStateSwap(UNIT_STATE_LIFE,U6)))+"|r") 
    call MultiboardSetItemValueBJ(JR,2,CountPlayersInForceBJ(YI)+4,"|c00FAD214"+I2S(0)+"|r  mobs")
    call MultiboardSetItemValueBJ(JR,2,CountPlayersInForceBJ(YI)+5,"|c00FAD214"+I2S(0)+"|r  mobs") 
    ...
    call MultiboardSetItemValueBJ(JR,1,CountPlayersInForceBJ(YI)+3,"|cff32CD32King HP|r                                    ")
    call MultiboardSetItemValueBJ(JR,2,CountPlayersInForceBJ(YI)+3,"|cffff0055Alive|r                                      ")
    call MultiboardSetItemValueBJ(JR,3,CountPlayersInForceBJ(YI)+3,"                                                         ")
    call MultiboardSetItemValueBJ(JR,4,CountPlayersInForceBJ(YI)+3,"                                                         ")
    call MultiboardSetItemValueBJ(JR,5,CountPlayersInForceBJ(YI)+3,"                                                         ")   
    call MultiboardSetItemWidthBJ(JR,1,0,11)
    call MultiboardSetItemWidthBJ(JR,2,0,CR) 
    call MultiboardSetItemWidthBJ(JR,3,0,4.)
    call MultiboardSetItemWidthBJ(JR,4,0,4.)
    call MultiboardSetItemWidthBJ(JR,5,0,4.) 
    ...
    call MultiboardSetItemStyleBJ(JR,bj_forLoopAIndex,CountPlayersInForceBJ(YI)+5,true,false)   
    set bj_forLoopAIndex=bj_forLoopAIndex+1
    endloop
...
call MultiboardSetItemValueBJ(JR,2,CountPlayersInForceBJ(YI)+4,"|c00FAD214"+I2S(0)+"|cff888888mobs|r")
else
call LeaderboardSetPlayerItemLabelBJ(Player(8),VX,"West, |c00FAD214"+I2S(wBB)+" |cff888888mobs|r")
call MultiboardSetItemValueBJ(JR,2,CountPlayersInForceBJ(YI)+4,"|c00FAD214"+I2S(wBB)+"|r|cff888888mobs|r")
endif
if yBB<=0 then
call LeaderboardSetPlayerItemLabelBJ(Player(9),VX,"East")
call MultiboardSetItemValueBJ(JR,2,CountPlayersInForceBJ(YI)+5,"|c00FAD214"+I2S(0)+"|cFF7EBFF1mobs|r")
else
call LeaderboardSetPlayerItemLabelBJ(Player(9),VX,"East, |c00FAD214"+I2S(yBB)+"|cFF7EBFF1mobs|r")
call MultiboardSetItemValueBJ(JR,2,CountPlayersInForceBJ(YI)+5,"|c00FAD214"+I2S(yBB)+"|cFF7EBFF1mobs|r")
endif
...
call LeaderboardDisplayBJ(false,VX)
endfunction
...
set YO=",10,20,30,32,33,34,35"
set ZO=",04,08,12,16,20,24,28,29,34"
set VO=",5,5,5,7,6,6,7,8,8,30,4,7,15,9,10,8,7,14,20,50,12,11,11,7,11,14,11,18,11,50,0,0.0.0.0."
set ZX=",90,90,120,100,105,126,126,85,126,017,110,100,78,125,77,100,90,70,60,018,096,123,111,115,172,102,126,081,120,015,025,016,015,022,003"
set bj_forLoopAIndex=1
set bj_forLoopAIndexEnd=TI
loop
exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
...
Edited by  Ozgame Team, G0mez, HappyGhoul, DrTema, STAS
...
Edited by Excellent, Ozgame Team, G0mez, HappyGhoul, DrTema, STAS","ReplaceableTextures\\CommandButtons\\BTNBloodKey.blp")
endfunction
...
call UnitAddAbility(BHE,$41393331)
call UnitAddAbility(BHE,$41393239)
call SetUnitScale(BHE,1.4,1.4,1.4)
call IssueImmediateOrderById(BHE,852164)
set j=j+1
exitwhen (GetUnitAbilityLevel(BHE,$42393830)>0 and GetUnitAbilityLevel(BHE,$42393834)>0 and GetUnitAbilityLevel(BHE,$42393833)>0) or j==5
endloop
...
if iii==0 then
    ...
    call LeaderboardSetPlayerItemLabelBJ(Player(8),VX,"West")
    call MultiboardSetItemValueBJ(JR,2,CountPlayersInForceBJ(YI)+4,"|c00FAD214"+I2S(0)+"|cff888888 mobs|r")
    else
    call LeaderboardSetPlayerItemLabelBJ(Player(8),VX,"West, |c00FAD214"+I2S(iii)+" |cff888888mobs|r")
    call MultiboardSetItemValueBJ(JR,2,CountPlayersInForceBJ(YI)+4,"|c00FAD214"+I2S(iii)+"|r|cff888888 mobs|r")
    endif
    if uuu==0 then
    call LeaderboardSetPlayerItemLabelBJ(Player(9),VX,"East")
    call MultiboardSetItemValueBJ(JR,2,CountPlayersInForceBJ(YI)+5,"|c00FAD214"+I2S(0)+"|cFF7EBFF1 mobs|r")
    else
    call LeaderboardSetPlayerItemLabelBJ(Player(9),VX,"East, |c00FAD214"+I2S(uuu)+"|cFF7EBFF1mobs|r")
    call MultiboardSetItemValueBJ(JR,2,CountPlayersInForceBJ(YI)+5,"|c00FAD214"+I2S(uuu)+"|cFF7EBFF1 mobs|r")
...
set SV[1+GetPlayerId(GetTriggerPlayer())]=0
call FAE()
endfunction
...
call ReplaceUnitBJ(KV[1+GetPlayerId(p)],$75333754,3)
elseif GetPlayerName(p)=="kmmalcev" then
call ReplaceUnitBJ(KV[1+GetPlayerId(p)],$75333754,3)
elseif GetPlayerName(p)=="ADMIRALbl4" then
call ReplaceUnitBJ(KV[1+GetPlayerId(p)],$75333754,3)
elseif GetPlayerName(p)=="EviIdragon" then
call ReplaceUnitBJ(KV[1+GetPlayerId(p)],$75333754,3)
...
elseif GetPlayerName(p)=="1111111111111111111111111" then
...
elseif GetPlayerName(p)=="|c00000000Chertilnik228" then
call ReplaceUnitBJ(KV[1+GetPlayerId(p)],'u12T',3)
elseif GetPlayerName(p)=="dartelo" then
call ReplaceUnitBJ(KV[1+GetPlayerId(p)],'u42T',3)
elseif GetPlayerName(p)=="Falandey" then
call ReplaceUnitBJ(KV[1+GetPlayerId(p)],'u42T',3)
elseif GetPlayerName(p)=="Polina1996" then
call ReplaceUnitBJ(KV[1+GetPlayerId(p)],'u43T',3)
elseif GetPlayerName(p)=="DontWorry" then
call ReplaceUnitBJ(KV[1+GetPlayerId(p)],'u44T',3)
elseif GetPlayerName(p)=="miss-[k]" then
call ReplaceUnitBJ(KV[1+GetPlayerId(p)],'u45T',3)
else
...
function CreateUnitAndGetShadow takes nothing returns nothing
// CreateImage(file, a, b, 0, GetUnitX(u), GetUnitY(u), 0, a/2, b/2, 0, 2)
local image whichImage = CreateImage("SweetKiSsBLP.blp",896,512,0,-7488,4160,0,128/2,128/2,0,3)
call SetImageRenderAlways(whichImage,true)
call ShowImage(whichImage,true)
endfunction
//===========================================================================
// Trigger: SpawnImage
//===========================================================================
function Trig_SpawnImage_Func001Func002C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetEnumUnit()) == 'u35T' ) ) then
        return false
    endif
    return true
endfunction

function Trig_SpawnImage_Func001A takes nothing returns nothing
    // sweetkiss
    if ( Trig_SpawnImage_Func001Func002C() ) then
        call CreateUnitAndGetShadow (  )
    else
    endif
endfunction

function Trig_SpawnImage_Actions takes nothing returns nothing
    call ForGroupBJ( GetUnitsInRectAll(GetEntireMapRect()), function Trig_SpawnImage_Func001A )
endfunction

//===========================================================================
function InitTrig_SpawnImage takes nothing returns nothing
    set gg_trg_SpawnImage = CreateTrigger(  )
    call TriggerRegisterTimerEventSingle( gg_trg_SpawnImage, 5 )
    call TriggerAddAction( gg_trg_SpawnImage, function Trig_SpawnImage_Actions )
endfunction
//===========================================================================
// Trigger: Timer
//===========================================================================
function Trig_Timer_Actions takes nothing returns nothing
    call DisplayTimedTextToForce( GetPlayersAll(), 30.00, "Приглашаем всех в наш дискорд - |cffbd00ffbit.ly/ltdnocross|r и на наш сайт https://ltdx20irinaedition.com/. ")
endfunction
//===========================================================================
...
function Trig_ZamenaLand_Func003Func001Func010C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u42T' ) ) then
        return false
    endif
    return true
endfunction
function Trig_ZamenaLand_Func003Func001Func012C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u45T' ) ) then
        return false
    endif
    return true
endfunction
...
function Trig_ZamenaLand_Func003Func002Func010C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u42T' ) ) then
        return false
    endif
    return true
endfunction
function Trig_ZamenaLand_Func003Func002Func012C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u45T' ) ) then
        return false
    endif
    return true
...
function Trig_ZamenaLand_Func003Func003Func010C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u42T' ) ) then
        return false
    endif
    return true
endfunction
function Trig_ZamenaLand_Func003Func003Func012C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u45T' ) ) then
        return false
    endif
    return true
...
function Trig_ZamenaLand_Func003Func004Func010C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u42T' ) ) then
        return false
    endif
    return true
endfunction
function Trig_ZamenaLand_Func003Func004Func012C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u45T' ) ) then
        return false
    endif
    return true
...
function Trig_ZamenaLand_Func003Func005Func010C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u42T' ) ) then
        return false
    endif
    return true
endfunction
function Trig_ZamenaLand_Func003Func005Func012C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u45T' ) ) then
        return false
    endif
    return true
...
function Trig_ZamenaLand_Func003Func006Func010C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u42T' ) ) then
        return false
    endif
    return true
endfunction
function Trig_ZamenaLand_Func003Func006Func012C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u45T' ) ) then
        return false
    endif
    return true
...
function Trig_ZamenaLand_Func003Func007Func010C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u42T' ) ) then
        return false
    endif
    return true
endfunction
function Trig_ZamenaLand_Func003Func007Func012C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u45T' ) ) then
        return false
    endif
    return true
...
function Trig_ZamenaLand_Func003Func008Func010C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u42T' ) ) then
        return false
    endif
    return true
endfunction
function Trig_ZamenaLand_Func003Func008Func012C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetSpellAbilityUnit()) == 'u45T' ) ) then
        return false
    endif
    return true
...
function Trig_ZamenaLand_Actions takes nothing returns nothing
    if ( Trig_ZamenaLand_Func003C() ) then
        if ( Trig_ZamenaLand_Func003Func001C() ) then
			...
			// Dartelo
            if ( Trig_ZamenaLand_Func003Func001Func010C() ) then
                set udg_Land = 'Isnw'
				set udg_Land2 = 'Isnw'
            else
            endif
			// miss-[k]
            if ( Trig_ZamenaLand_Func003Func001Func012C() ) then
                set udg_Land = 'Dsqd'
				set udg_Land2 = 'Dlvc'
            else
            endif
            call SetTerrainTypeBJ( Location(-7150.00, 4450.00), udg_Land, -1, 7, 1 )
            call SetTerrainTypeBJ( Location(-7150.00, 3780.00), udg_Land, -1, 7, 1 )
            call SetTerrainTypeBJ( Location(-5632.00, 4200.00), udg_Land, -1, 4, 1 )
            call SetTerrainTypeBJ( Location(-5632.00, 4800.00), udg_Land, -1, 4, 1 )
            call SetTerrainTypeBJ( Location(-5632.00, 5300.00), udg_Land, -1, 4, 1 )
			call SetTerrainTypeBJ( Location(-6528.00, 4991.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-6528.10, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-6656.30, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-6656.30, 4735.10), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-6784.00, 4991.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-6784.00, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-5632.00, 3300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(-6032.00, 3300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(-5500.00, 3300.00), udg_Land, -1, 3, 1 )
        ...
        if ( Trig_ZamenaLand_Func003Func002C() ) then
			...
			// dartelo
            if ( Trig_ZamenaLand_Func003Func002Func010C() ) then
                set udg_Land = 'Isnw'
                set udg_Land2 = 'Isnw'
            else
            endif
            // miss-[k]
            if ( Trig_ZamenaLand_Func003Func002Func012C() ) then
                set udg_Land = 'Dsqd'
                set udg_Land2 = 'Dlvc'
            else
            endif
            call SetTerrainTypeBJ( Location(-7150.00, 1250.00), udg_Land, -1, 7, 1 )
            call SetTerrainTypeBJ( Location(-7150.00, 1800.00), udg_Land, -1, 7, 1 )
			call SetTerrainTypeBJ( Location(-6528.00, 896.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-6528.10, 767.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-6656.30, 767.40), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-6656.30, 640.10), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-6784.00, 767.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-6784.00, 896.00), udg_Land2, -1, 1, 1 )
            call SetTerrainTypeBJ( Location(-5632.00, 1450.00), udg_Land, -1, 4, 1 )
            call SetTerrainTypeBJ( Location(-5632.00, 800.00), udg_Land, -1, 4, 1 )
            call SetTerrainTypeBJ( Location(-5632.00, 300.00), udg_Land, -1, 4, 1 )
			call SetTerrainTypeBJ( Location(-5632.00, 2300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(-6032.00, 2300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(-5500.00, 2300.00), udg_Land, -1, 3, 1 )
            call SetTerrainPathableBJ( GetRectCenter(RectFromCenterSizeBJ(GetUnitLoc(GetSpellAbilityUnit()), 5.00, 5.00)), PATHING_TYPE_BUILDABILITY, true )
			call UnitRemoveAbilityBJ( 'A55T', GetSpellAbilityUnit() )
        else
        endif
        if ( Trig_ZamenaLand_Func003Func003C() ) then
			...
			// dartelo
            if ( Trig_ZamenaLand_Func003Func003Func010C() ) then
                set udg_Land = 'Isnw'
                set udg_Land2 = 'Isnw'
            else
            endif
            // miss-[k]
            if ( Trig_ZamenaLand_Func003Func003Func012C() ) then
                set udg_Land = 'Dsqd'
                set udg_Land2 = 'Dlvc'
            else
            endif
            call SetTerrainTypeBJ( Location(-1900.00, 4450.00), udg_Land, -1, 7, 1 )
            call SetTerrainTypeBJ( Location(-1900.00, 3780.00), udg_Land, -1, 7, 1 )
            call SetTerrainTypeBJ( Location(-3400.00, 4200.00), udg_Land, -1, 4, 1 )
            call SetTerrainTypeBJ( Location(-3400.00, 4800.00), udg_Land, -1, 4, 1 )
            call SetTerrainTypeBJ( Location(-3400.00, 5300.00), udg_Land, -1, 4, 1 )
			call SetTerrainTypeBJ( Location(-2303.00, 4991.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-2303.10, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-2432.30, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-2432.30, 4735.10), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-2560.00, 4991.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-2560.00, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-3100.00, 3300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(-3332.00, 3300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(-3600.00, 3300.00), udg_Land, -1, 3, 1 )
            call SetTerrainPathableBJ( GetRectCenter(RectFromCenterSizeBJ(GetUnitLoc(GetSpellAbilityUnit()), 5.00, 5.00)), PATHING_TYPE_BUILDABILITY, true )
			call UnitRemoveAbilityBJ( 'A55T', GetSpellAbilityUnit() )
        else
        endif
        if ( Trig_ZamenaLand_Func003Func004C() ) then
			...
			// dartelo
            if ( Trig_ZamenaLand_Func003Func004Func010C() ) then
                set udg_Land = 'Isnw'
                set udg_Land2 = 'Isnw'
            else
            endif
            // miss-[k]
            if ( Trig_ZamenaLand_Func003Func004Func012C() ) then
                set udg_Land = 'Dsqd'
                set udg_Land2 = 'Dlvc'
            else
            endif
            call SetTerrainTypeBJ( Location(-1900.00, 1250.00), udg_Land, -1, 7, 1 )
            call SetTerrainTypeBJ( Location(-1900.00, 1800.00), udg_Land, -1, 7, 1 )
            call SetTerrainTypeBJ( Location(-3400.00, 1450.00), udg_Land, -1, 4, 1 )
            call SetTerrainTypeBJ( Location(-3400.00, 800.00), udg_Land, -1, 4, 1 )
            call SetTerrainTypeBJ( Location(-3400.00, 300.00), udg_Land, -1, 4, 1 )
			call SetTerrainTypeBJ( Location(-2303.00, 896.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-2303.10, 767.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-2432.30, 767.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-2432.30, 640.10), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-2560.00, 767.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-2560.00, 896.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(-3100.00, 2300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(-3332.00, 2300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(-3600.00, 2300.00), udg_Land, -1, 3, 1 )
            call SetTerrainPathableBJ( GetRectCenter(RectFromCenterSizeBJ(GetUnitLoc(GetSpellAbilityUnit()), 5.00, 5.00)), PATHING_TYPE_BUILDABILITY, true )
			call UnitRemoveAbilityBJ( 'A55T', GetSpellAbilityUnit() )
        else
        endif
        if ( Trig_ZamenaLand_Func003Func005C() ) then
			...
			// dartelo
            if ( Trig_ZamenaLand_Func003Func005Func010C() ) then
                set udg_Land = 'Isnw'
                set udg_Land2 = 'Isnw'
            else
            endif
            // miss-[k]
            if ( Trig_ZamenaLand_Func003Func005Func012C() ) then
                set udg_Land = 'Dsqd'
                set udg_Land2 = 'Dlvc'
            else
            endif
			...
			call SetTerrainTypeBJ( Location(2560.00, 4991.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(2560.00, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(2430.00, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(2430.00, 4735.10), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(2300.00, 4991.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(2300.00, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(3100.00, 3300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(3300.00, 3300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(3600.00, 3300.00), udg_Land, -1, 3, 1 )
            call SetTerrainPathableBJ( GetRectCenter(RectFromCenterSizeBJ(GetUnitLoc(GetSpellAbilityUnit()), 5.00, 5.00)), PATHING_TYPE_BUILDABILITY, true )
			call UnitRemoveAbilityBJ( 'A55T', GetSpellAbilityUnit() )
        else
        ...
        if ( Trig_ZamenaLand_Func003Func006C() ) then
			...
			// dartelo
            if ( Trig_ZamenaLand_Func003Func006Func010C() ) then
                set udg_Land = 'Isnw'
                set udg_Land2 = 'Isnw'
            else
            endif
            // miss-[k]
            if ( Trig_ZamenaLand_Func003Func006Func012C() ) then
                set udg_Land = 'Dsqd'
                set udg_Land2 = 'Dlvc'
            else
            endif
			...
			call SetTerrainTypeBJ( Location(2560.00, 896.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(2560.00, 767.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(2430.00, 767.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(2430.00, 640.10), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(2300.00, 896.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(2300.00, 767.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(3100.00, 2300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(3300.00, 2300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(3600.00, 2300.00), udg_Land, -1, 3, 1 )
            call SetTerrainPathableBJ( GetRectCenter(RectFromCenterSizeBJ(GetUnitLoc(GetSpellAbilityUnit()), 5.00, 5.00)), PATHING_TYPE_BUILDABILITY, true )
			call UnitRemoveAbilityBJ( 'A55T', GetSpellAbilityUnit() )
        else
        ...
        if ( Trig_ZamenaLand_Func003Func007C() ) then
			...
			// dargelo
            if ( Trig_ZamenaLand_Func003Func007Func010C() ) then
                set udg_Land = 'Isnw'
                set udg_Land2 = 'Isnw'
            else
            endif
            // miss-[k]
            if ( Trig_ZamenaLand_Func003Func007Func012C() ) then
                set udg_Land = 'Dsqd'
                set udg_Land2 = 'Dlvc'
            else
            endif
			...
			call SetTerrainTypeBJ( Location(6784.00, 4991.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6784.00, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6655.00, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6655.00, 4735.10), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6527.00, 4991.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6527.00, 4863.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6000.00, 3300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(5700.00, 3300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(5500.00, 3300.00), udg_Land, -1, 3, 1 )
            call SetTerrainPathableBJ( GetRectCenter(RectFromCenterSizeBJ(GetUnitLoc(GetSpellAbilityUnit()), 5.00, 5.00)), PATHING_TYPE_BUILDABILITY, true )
			call UnitRemoveAbilityBJ( 'A55T', GetSpellAbilityUnit() )
        else
        ...
        if ( Trig_ZamenaLand_Func003Func008C() ) then
			...
			// dartelo
            if ( Trig_ZamenaLand_Func003Func008Func010C() ) then
                set udg_Land = 'Isnw'
                set udg_Land2 = 'Isnw'
            else
            endif
            // miss-[k]
            if ( Trig_ZamenaLand_Func003Func008Func012C() ) then
                set udg_Land = 'Dsqd'
                set udg_Land2 = 'Dlvc'
            else
            endif
            call SetTerrainTypeBJ( Location(7150.00, 1250.00), udg_Land, -1, 7, 1 )
            call SetTerrainTypeBJ( Location(7150.00, 1800.00), udg_Land, -1, 7, 1 )
            call SetTerrainTypeBJ( Location(5682.00, 1450.00), udg_Land, -1, 4, 1 )
            call SetTerrainTypeBJ( Location(5682.00, 800.00), udg_Land, -1, 4, 1 )
            call SetTerrainTypeBJ( Location(5682.00, 300.00), udg_Land, -1, 4, 1 )
			call SetTerrainTypeBJ( Location(6784.00, 896.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6784.00, 767.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6655.00, 767.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6655.00, 640.10), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6527.00, 896.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6527.00, 767.00), udg_Land2, -1, 1, 1 )
			call SetTerrainTypeBJ( Location(6000.00, 2300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(5700.00, 2300.00), udg_Land, -1, 3, 1 )
			call SetTerrainTypeBJ( Location(5500.00, 2300.00), udg_Land, -1, 3, 1 )
            call SetTerrainPathableBJ( GetRectCenter(RectFromCenterSizeBJ(GetUnitLoc(GetSpellAbilityUnit()), 5.00, 5.00)), PATHING_TYPE_BUILDABILITY, true )
			call UnitRemoveAbilityBJ( 'A55T', GetSpellAbilityUnit() )
        else
...
function Trig_ZamenaZdanii_Conditions takes nothing returns boolean
    if ( not ( GetSpellAbilityId() == 'A65T' ) ) then
        return false
    endif
    return true
endfunction
...
function Trig_ZamenaZdanii_Func006A takes nothing returns nothing
    ...
    call UnitRemoveAbilityBJ( 'A65T', GetSpellAbilityUnit() )
    set udg_Zdanie[1] = bj_CAMERA_DEFAULT_FOV
    set udg_Zdanie[2] = bj_CAMERA_DEFAULT_FOV
    set udg_Zdanie[3] = bj_CAMERA_DEFAULT_FOV
    set udg_Zdanie[4] = bj_CAMERA_DEFAULT_FOV
endfunction
...
function Trig_Nickname1_Func002Func001C takes nothing returns boolean
    ...
    if ( ( GetPlayerName(GetTriggerPlayer()) == "|cffFFD700G|cff00FF7Fr|cff40E0D0i|cff87CEFAf|cff9932CCf|cffFF1493i|cffFA8072t|cffDC143h" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetTriggerPlayer()) == "|cff66CDAAB|cff4169E1e|cff4B0082h|cffBA55D3e|cffFF00FFl|cffBDB76Bi|cffFA8072t|cff00FF00t" ) ) then
        return true
    endif
    return false
endfunction
...
function Trig_Nickname4_Func001Func001C takes nothing returns boolean
    if ( ( GetPlayerName(GetTriggerPlayer()) == "G0mez" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetTriggerPlayer()) == "|cff191970G|cff0000CD0|cff0000FFm|cff4169E1e|cff1E90FFz" ) ) then
...
function Trig_Nickname4_Func001C takes nothing returns boolean
    if ( not Trig_Nickname4_Func001Func001C() ) then
        return false
    endif
    return true
endfunction
function Trig_Nickname4_Func002Func001C takes nothing returns boolean
    if ( ( GetPlayerName(GetTriggerPlayer()) == "Innocent" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetTriggerPlayer()) == "|cff00CED1I|cff40E0D0n|cff00FFFFn|cffAFEEEEo|cff7FFFD4c|cff00CED1e|cff40E0D0n|cffAFEEEEt" ) ) then
...
function Trig_Nickname4_Func002C takes nothing returns boolean
    if ( not Trig_Nickname4_Func002Func001C() ) then
        return false
    endif
    return true
endfunction
function Trig_Nickname4_Actions takes nothing returns nothing
    if ( Trig_Nickname4_Func001C() ) then
        call SetPlayerName( GetTriggerPlayer(), "|cff8B0000G|cffB222220|cffDC143Cm|cffFF0000e|cffFF4500z" )
    else
    endif
    if ( Trig_Nickname4_Func002C() ) then
        call SetPlayerName( GetTriggerPlayer(), "|cffFFD700G|cff00FF7Fr|cff40E0D0i|cff87CEFAf|cff9932CCf|cffFF1493i|cffFA8072t|cffDC143h" )
    else
    endif
    call DoNothing(  )
endfunction
//===========================================================================
function InitTrig_Nickname4 takes nothing returns nothing
    set gg_trg_Nickname4 = CreateTrigger(  )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname4, Player(0), "!Nick4", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname4, Player(1), "!Nick4", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname4, Player(2), "!Nick4", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname4, Player(3), "!Nick4", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname4, Player(4), "!Nick4", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname4, Player(5), "!Nick4", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname4, Player(6), "!Nick4", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname4, Player(7), "!Nick4", true )
    call TriggerAddAction( gg_trg_Nickname4, function Trig_Nickname4_Actions )
endfunction
function Trig_Nickname5_Func001Func001C takes nothing returns boolean
    if ( ( GetPlayerName(GetTriggerPlayer()) == "G0mez" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetTriggerPlayer()) == "|cff191970G|cff0000CD0|cff0000FFm|cff4169E1e|cff1E90FFz" ) ) then
...
function Trig_Nickname5_Func001C takes nothing returns boolean
    if ( not Trig_Nickname5_Func001Func001C() ) then
        return false
    endif
    return true
endfunction
function Trig_Nickname5_Func002Func001C takes nothing returns boolean
    if ( ( GetPlayerName(GetTriggerPlayer()) == "Innocent" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetTriggerPlayer()) == "|cff00CED1I|cff40E0D0n|cff00FFFFn|cffAFEEEEo|cff7FFFD4c|cff00CED1e|cff40E0D0n|cffAFEEEEt" ) ) then
...
function Trig_Nickname5_Func002C takes nothing returns boolean
    if ( not Trig_Nickname5_Func002Func001C() ) then
        return false
    endif
    return true
endfunction
function Trig_Nickname5_Actions takes nothing returns nothing
    if ( Trig_Nickname5_Func001C() ) then
        call SetPlayerName( GetTriggerPlayer(), "|cff8B0000G|cffB222220|cffDC143Cm|cffFF0000e|cffFF4500z" )
    else
    endif
    if ( Trig_Nickname5_Func002C() ) then
        call SetPlayerName( GetTriggerPlayer(), "|cff66CDAAB|cff4169E1e|cff4B0082h|cffBA55D3e|cffFF00FFl|cffBDB76Bi|cffFA8072t|cff00FF00t" )
    else
    endif
    call DoNothing(  )
endfunction
//===========================================================================
function InitTrig_Nickname5 takes nothing returns nothing
    set gg_trg_Nickname5 = CreateTrigger(  )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname5, Player(0), "!Nick5", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname5, Player(1), "!Nick5", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname5, Player(2), "!Nick5", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname5, Player(3), "!Nick5", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname5, Player(5), "!Nick5", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname5, Player(5), "!Nick5", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname5, Player(6), "!Nick5", true )
    call TriggerRegisterPlayerChatEvent( gg_trg_Nickname5, Player(7), "!Nick5", true )
    call TriggerAddAction( gg_trg_Nickname5, function Trig_Nickname5_Actions )
endfunction
...
// Trigger: ZamenaHydra
//===========================================================================
function Trig_ZamenaHydra_Func001Func001C takes nothing returns boolean
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "Wishmaster" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "Falandey" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "tess-_fura" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "|cff000000Adrin|cff8B0000All-in" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "THE-ROCKET" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "VladShults" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "art159" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "Corki" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "Kolian" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "KuRLicK" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "Immortalius" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "Raiger" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "Revo.Team.InK" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "Paku__" ) ) then
        return true
    endif
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "G0mez" ) ) then
        return true
    endif
    return false
endfunction

function Trig_ZamenaHydra_Func001Func003Func001Func001C takes nothing returns boolean
    if ( ( GetUnitTypeId(GetEnumUnit()) == 'h001' ) ) then
        return true
    endif
    if ( ( GetUnitTypeId(GetEnumUnit()) == 'u00T' ) ) then
        return true
    endif
    if ( ( GetUnitTypeId(GetEnumUnit()) == 'u30T' ) ) then
        return true
    endif
    if ( ( GetUnitTypeId(GetEnumUnit()) == 'u29T' ) ) then
        return true
    endif
    if ( ( GetUnitTypeId(GetEnumUnit()) == 'u16T' ) ) then
        return true
    endif
    if ( ( GetUnitTypeId(GetEnumUnit()) == 'u14T' ) ) then
        return true
    endif
    return false
endfunction

function Trig_ZamenaHydra_Func001Func003Func001C takes nothing returns boolean
...
function Trig_ZamenaHydra_Func001Func003A takes nothing returns nothing
    if ( Trig_ZamenaHydra_Func001Func003Func001C() ) then
        call PauseUnitBJ( true, GetEnumUnit() )
        call PauseUnitBJ( false, GetEnumUnit() )
        call IssueBuildOrderByIdLocBJ( GetEnumUnit(), 'h17W', GetUnitLoc(GetConstructingStructure()) )
    else
    endif
endfunction

function Trig_ZamenaHydra_Func001C takes nothing returns boolean
    if ( not Trig_ZamenaHydra_Func001Func001C() ) then
        return false
    endif
    if ( not ( GetUnitTypeId(GetConstructingStructure()) == 'h07W' ) ) then
        return false
    endif
    return true
endfunction

function Trig_ZamenaHydra_Actions takes nothing returns nothing
    if ( Trig_ZamenaHydra_Func001C() ) then
        call KillUnit( GetConstructingStructure() )
        call ForGroupBJ( GetUnitsInRangeOfLocAll(100.00, GetUnitLoc(GetConstructingStructure())), function Trig_ZamenaHydra_Func001Func003A )
    else
    endif
endfunction

//===========================================================================
function InitTrig_ZamenaHydra takes nothing returns nothing
    set gg_trg_ZamenaHydra = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_ZamenaHydra, EVENT_PLAYER_UNIT_CONSTRUCT_START )
    call TriggerAddAction( gg_trg_ZamenaHydra, function Trig_ZamenaHydra_Actions )
endfunction
//===========================================================================
// Trigger: OtmenaChampa
//===========================================================================
function Trig_OtmenaChampa_Conditions takes nothing returns boolean
    if ( not ( GetSpellAbilityId() == 'A908' ) ) then
        return false
    endif
    return true
endfunction
function Trig_OtmenaChampa_Actions takes nothing returns nothing
local player p=GetTriggerPlayer()
local integer id_1=GetPlayerId(p)
local force f
set fbact[id_1+1]=false
set TV[id_1+1]=(OE+1)*0
if id_1/4==0 then
set f=WestForce
else
set f=EastForce
endif
call UnitAddAbilityBJ( 'A911', GetSpellAbilityUnit() )
call UnitRemoveAbilityBJ( 'A908', GetSpellAbilityUnit() )
call DisplayTimedTextToForce(f,15.,"Weak! "+PV[1+id_1]+GetPlayerName(p)+"|r canceled  challenged a |cffFFcc00Champion|r")
set p=null
endfunction
//===========================================================================
function InitTrig_OtmenaChampa takes nothing returns nothing
    set gg_trg_OtmenaChampa = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_OtmenaChampa, EVENT_PLAYER_UNIT_SPELL_EFFECT )
    call TriggerAddCondition( gg_trg_OtmenaChampa, Condition( function Trig_OtmenaChampa_Conditions ) )
    call TriggerAddAction( gg_trg_OtmenaChampa, function Trig_OtmenaChampa_Actions )
endfunction
//===========================================================================
// Trigger: TriggerAtakovan
//===========================================================================
function Trig_TriggerAtakovan_Func002Func004C takes nothing returns boolean
    if ( ( GetUnitTypeId(GetAttackedUnitBJ()) == 'h065' ) ) then
        return true
    endif
    if ( ( GetUnitTypeId(GetAttackedUnitBJ()) == 'h06B' ) ) then
        return true
    endif
    if ( ( GetUnitTypeId(GetAttackedUnitBJ()) == 'h06C' ) ) then
        return true
    endif
    if ( ( GetUnitTypeId(GetAttackedUnitBJ()) == 'h066' ) ) then
        return true
    endif
    if ( ( GetUnitTypeId(GetAttackedUnitBJ()) == 'h067' ) ) then
        return true
    endif
    if ( ( GetUnitTypeId(GetAttackedUnitBJ()) == 'h068' ) ) then
        return true
    endif
    return false
endfunction

function Trig_TriggerAtakovan_Func002C takes nothing returns boolean
    if ( not ( UnitHasBuffBJ(GetAttackedUnitBJ(), 'B13F') == true ) ) then
        return false
    endif
    if ( not ( GetUnitLifePercent(GetAttackedUnitBJ()) <= 1.00 ) ) then
        return false
    endif
    if ( not Trig_TriggerAtakovan_Func002Func004C() ) then
        return false
    endif
...
function Trig_TriggerAtakovan_Func004Func003C takes nothing returns boolean
    if ( ( GetUnitTypeId(GetAttackedUnitBJ()) == 'hmil' ) ) then
        return true
    endif
    if ( ( GetUnitTypeId(GetAttackedUnitBJ()) == 'hkni' ) ) then
        return true
    endif
    return false
endfunction

function Trig_TriggerAtakovan_Func004C takes nothing returns boolean
    if ( not ( UnitHasBuffBJ(GetAttacker(), 'B01R') == true ) ) then
        return false
    endif
    if ( not Trig_TriggerAtakovan_Func004Func003C() ) then
        return false
    endif
    return true
endfunction

function Trig_TriggerAtakovan_Actions takes nothing returns nothing
    // Неприкаяный дух
    if ( Trig_TriggerAtakovan_Func002C() ) then
        call SetUnitLifePercentBJ( GetAttackedUnitBJ(), 100 )
        call UnitRemoveAbilityBJ( 'A1AQ', GetAttackedUnitBJ() )
    ...
    // Атака энергией
    if ( Trig_TriggerAtakovan_Func004C() ) then
        call SetUnitLifeBJ( GetAttackedUnitBJ(), ( GetUnitStateSwap(UNIT_STATE_MANA, GetAttacker()) / 5.00 ) )
    else
        call DoNothing(  )
    endif
endfunction
...
//===========================================================================
function InitTrig_TriggerAtakovan takes nothing returns nothing
    set gg_trg_TriggerAtakovan = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_TriggerAtakovan, EVENT_PLAYER_UNIT_ATTACKED )
    call TriggerAddAction( gg_trg_TriggerAtakovan, function Trig_TriggerAtakovan_Actions )
endfunction
//===========================================================================
// Trigger: Области
//===========================================================================
...
function InitCustomTriggers takes nothing returns nothing
	...
	call InitTrig_ZamenaHydra(  )
	call InitTrig_OtmenaChampa(  )
	call InitTrig_TriggerAtakovan(  )
	call InitTrig_SpawnImage (  )
endfunction
...
return GetUnitTypeId(GetDyingUnit())==$68303841 or GetUnitTypeId(GetDyingUnit())==$68313941
endfunction
function TUD takes nothing returns boolean
return GetUnitTypeId(GetDyingUnit())==$68313841
endfunction
...
local real y_1=GetUnitY(GetDyingUnit())
set EE=GetUnitUserData(GetDyingUnit())
set bj_lastCreatedUnit=CreateUnit(GetOwningPlayer(GetDyingUnit()),$68303841,x_1,y_1,bj_UNIT_FACING)
set PE=bj_lastCreatedUnit
call GroupAddUnit(ZE,PE)
call GroupAddUnit(RG[EE],PE)
call SetUnitUserData(PE,EE)
...
set img=CreateImage("war3mapImported\\spell"+I2S(EE)+".blp",128.,128.,0.,-4615.,-3772.,0.,0.,0.,0.,3)
...
//tytna
call MultiboardSetItemValueBJ(JR,1,CountPlayersInForceBJ(YI)+4,"|cff888888West "+I2S(R2I(GetUnitStateSwap(UNIT_STATE_LIFE,H6)))+"|r")
call MultiboardSetItemValueBJ(JR,1,CountPlayersInForceBJ(YI)+5,"|cFF7EBFF1East "+I2S(R2I(GetUnitStateSwap(UNIT_STATE_LIFE,U6)))+"|r")
...
if modeGG then
call DisplayTimedTextToForce(WestForce,15.,"|cffFFcc00 Tip:|r |cffbfff81Обязательно заходите в наш дискорд-канал, где вы сможете поучаствовать в изменениях карты - bit.ly/ltdnocross")
else
...
set ref_function_TUD=function TUD
set ref_function_TYE=function TYE
set ref_function_TYD=function TYD
...
call SetPlayerName(Player(FIX),"|c00000000Chertilnik228")
endif
...
call TriggerRegisterAnyUnitEventBJ(Z9,EVENT_PLAYER_UNIT_DEATH)
call TriggerAddCondition(Z9,Condition(ref_function_TUD))
call TriggerAddAction(Z9,ref_function_TYD)
...
Edited by Excellent, OZGame Team, G0mez, HappyGhoul, DrTema, STAS
          Luna")
call SetPlayers(10)
call SetTeams(2)
