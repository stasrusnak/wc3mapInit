...
group array IJ
	...
	trigger                 gg_trg_ZamenaSEGA        = null
...
elseif GetPlayerName(p)=="|cff0000CD-SEGA" then
...
function Trig_ZamenaHydra_Func001Func001C takes nothing returns boolean
    ...
    if ( ( GetPlayerName(GetOwningPlayer(GetConstructingStructure())) == "dartelo" ) ) then
        return true
    endif
...
function Trig_ZamenaHydra_Func001Func003Func001Func001C takes nothing returns boolean
    ...
    if ( ( GetUnitTypeId(GetEnumUnit()) == 'u42T' ) ) then
        return true
    endif
    return false
endfunction
...
// Trigger: ZamenaSEGA
//===========================================================================
function Trig_ZamenaSEGA_Func001Func001001 takes nothing returns boolean
    return ( GetUnitTypeId(GetEnumUnit()) == 'u45T' )
endfunction

function Trig_ZamenaSEGA_Func001A takes nothing returns nothing
...
function Trig_ZamenaSEGA_Actions takes nothing returns nothing
    call ForGroupBJ( GetUnitsInRectAll(GetEntireMapRect()), function Trig_ZamenaSEGA_Func001A )
endfunction

//===========================================================================
function InitTrig_ZamenaSEGA takes nothing returns nothing
    set gg_trg_ZamenaSEGA = CreateTrigger(  )
    call TriggerRegisterTimerEventSingle( gg_trg_ZamenaSEGA, 5 )
    call TriggerAddAction( gg_trg_ZamenaSEGA, function Trig_ZamenaSEGA_Actions )
endfunction
...
return GetUnitTypeId(GetAttacker())==$68303841 or GetUnitTypeId(GetAttacker())==$68313941 or GetUnitTypeId(GetAttacker())==$68313841
endfunction
...
return GetUnitTypeId(GetDyingUnit())==$68303841 or GetUnitTypeId(GetDyingUnit())==$68313941 or GetUnitTypeId(GetDyingUnit())==$68313841
endfunction
...
function SetMUITimer takes string LocTeam returns integer
...
function GetMUITimer takes string LocTeam returns timer
	return LoadTimerHandle( W3MMDTable, GetHandleId( W3MMDTable ), StringHash( LocTeam ) )
endfunction	
...
function Death_Handler takes unit Killer, unit Dying returns nothing
	local integer D_PID = GetPlayerId( GetOwningPlayer( Dying ) )
	local integer D_UID = GetUnitTypeId( Dying )
	if D_UID == 'h00K' then // LEFT KING 
        call W3MMD_Lite_Flag_Loser( Player(0) )
        call W3MMD_Lite_Flag_Loser( Player(1) )
        call W3MMD_Lite_Flag_Loser( Player(2) )
        call W3MMD_Lite_Flag_Loser( Player(3) )
        call W3MMD_Lite_Flag_Winner( Player(4) )
        call W3MMD_Lite_Flag_Winner( Player(5) )
        call W3MMD_Lite_Flag_Winner( Player(6) )
        call W3MMD_Lite_Flag_Winner( Player(7) )
	endif  
    if D_UID == 'h06H' then // RIGHT KING 
        call W3MMD_Lite_Flag_Winner( Player(0) )
        call W3MMD_Lite_Flag_Winner( Player(1) )
        call W3MMD_Lite_Flag_Winner( Player(2) )
        call W3MMD_Lite_Flag_Winner( Player(3) )
        call W3MMD_Lite_Flag_Loser( Player(4) )
        call W3MMD_Lite_Flag_Loser( Player(5) )
        call W3MMD_Lite_Flag_Loser( Player(6) )
        call W3MMD_Lite_Flag_Loser( Player(7) )
	endif  
endfunction
function Death_Event takes nothing returns nothing
	call Death_Handler( GetKillingUnit( ), GetDyingUnit( ) )
endfunction
function Custom_Systems takes nothing returns nothing
...
local integer i
call ExecuteFunc( "W3MMDInit" )
call ExecuteFunc( "InitForfeit" )
call ExecuteFunc( "Custom_Systems" )
call initGlobals()
...
elseif GetPlayerName(Player(FIX))=="-SEGA" then
call SetPlayerName(Player(FIX),"|cff0000CD-SEGA")
endif
